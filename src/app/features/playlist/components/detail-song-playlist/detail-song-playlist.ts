...
import { SongsList } from '../../../../core/models/playlist.model';
...
@Component({
  ...
  selector: 'app-detail-song-playlist',
  styleUrl: './detail-song-playlist.css',
  templateUrl: './detail-song-playlist.html',
})
export class DetailSongPlaylist {
  ...
  public $song = input<SongsList>();
  public $index = input<number>();

  public songSelected = output<SongsList>();
  ...
  public $isLoading = computed(() => {
    ...
    return !!(isServiceLoading && currentTrack?.videoId && song?.videoId && currentTrack.videoId === song.videoId);
  });
  ...
  public onImageError(): void {
    ...
    // Evitar tormenta de reintentos si estamos ante rate-limiting o ya se intentó
